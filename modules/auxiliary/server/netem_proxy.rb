  ...
  def initialize(info = {})
    ...
    register_options(
      [
        ...
        OptFloat.new("DataRate",      [false, 'Data rate in Mbps (0 is unlimited)', 0.0]),
        OptFloat.new("PacketLoss",    [false, 'Packet loss percentage', 0.0]),
        OptFloat.new("PacketDup",     [false, 'Packet dup percentage', 0.0]),
        OptFloat.new("PacketCorrupt", [false, 'Packet corruption percentage', 0.0]),

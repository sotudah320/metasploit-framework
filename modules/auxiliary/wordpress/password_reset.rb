  ...
  def initialize(info = {})
    super(
      update_info(
        ...
        'Name' => 'password reset',
        'version' => '$Revision: 1$',
        'Description' => %q(Wordpress has a password reset feature that
          contains a vulnerability which might in some cases allow attackers to
          get hold of the password reset link without previous authentication.
